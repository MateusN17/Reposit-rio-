...
class TelaInicio(Screen):
    def __init__(self, **kwargs):
        ...
        scroll_view = ScrollView(size_hint=(None, None), size=(400, 400), pos_hint={'center_x': 0.5, 'center_y': 0.5})
        ...
        bottom_bar_layout = GridLayout(cols=5, size_hint_y=None, height=120, padding = 40)
        self.add_widget(bottom_bar_layout)

        # Adicionando os ícones separados na barra inferior
        lista=['perfil.png','chats.png','mais.png','coração.png','home.png']
        for icon_name in lista:
            icon_button = ImageButton(source=icon_name, size_hint=(None,None), size=(70,50))
    ...
    def on_icon_click(self, instance):
        ...
        elif instance.source == '/Users/mateu/Downloads/add-bell-notification--notification-alarm-alert-bell-add.png':
            app.root.current = 'tela_secundaria'
        elif instance.source == 'coração.png':
            app.root.current = 'tela_favorito'
...
class Umatela(App):
    def build(self):
        ...
        tela_secundaria = TelaSecundaria(name='tela_secundaria')
        ...
        tela_favorito=TelaFavorito(name='tela_favorito')

        # Adicionando as telas ao gerenciador
        self.root.add_widget(tela_inicio)
        self.root.add_widget(tela_secundaria)
        ...
        self.root.add_widget(tela_favorito)
